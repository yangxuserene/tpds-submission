...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.7 in]{syn-wkld/mg/commtime}
        \caption{MultiGrid}
...
%    \hspace{1em}%
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.7 in]{syn-wkld/cr/commtime}
...
%    \hspace{1em}%
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.7 in]{syn-wkld/amg10/commtime}
        \caption{sAMG}
